...
//  CodeBreaker
//
//  Created by app-kaihatsusha on 18/03/2026.
...
extension CodeBreaker: Codable {
    ...
    convenience init(from decoder: Decoder) throws {
        self.init() // temporary initialisation, overirde below
        ...
        self.lastAttemptedDate = try container.decodeIfPresent(Date.self, forKey: .lastAttemptedDate)
    ...
    func encode(to encoder: any Encoder) throws {
        ...
        try container.encodeIfPresent(lastAttemptedDate, forKey: .lastAttemptedDate)
